...
int Icglue_Init (Tcl_Interp *interp) {
    ...
    log_info ("PLoad", "a Tcl-Library for scripted HDL generation");
    log_info ("PLoad", "Copyright (C) Andreas Dixius, Felix Neumärker");
    log_info ("PLoad", "Use and redistribute under the terms of the GNU General Public License version 3");
