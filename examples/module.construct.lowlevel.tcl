...
connect -from [get_instances -name proc_mgmt] -to [list [get_modules -name tb_proc_top] [get_modules -name proc_top]:clk_test! [get_instances -name proc_core]:clk!] -signal-name clk
connect -from [get_modules -name tb_proc_top] -to [list [get_instances -name proc_mgmt]:clk_src!] -signal-name clk_ref
