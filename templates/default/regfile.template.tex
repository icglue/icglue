...
%>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%% generated register file documentation  %%%%%%%%%%%%%%%%
%% please include the following latex packages:
%  \usepackage{xstring}             % needed for IfStrEqCase structure
%  \usepackage{xcolor}              % needed for register diagram
%  \usepackage[color]{register}     % register diagram use v1.7+
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% usage:
%% \getReg{regfile}{register.table}     % get table entry of register
%%                          .address}   % get address of register
%%                          .diag}      % get register diagram
%%                          .comment}   % get register comment for diagram
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% register table header (comment in if needed)
...
<%  foreach_array reg $register_list {
        %><%= "\{" $reg(name) ".addr\}\{"%><[format "0x%08x" $reg(address)]><%= "\}\%\n"%><%
    }
%>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% register diagram
<%  foreach_array reg $register_list {
...
%>}%
%>%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    }  % keep these closing brace!
   }   % keep these closing brace!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% }    % comment in if file used standalone
%}     % comment in if file used standalone