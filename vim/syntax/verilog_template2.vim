...
" template part
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
syn region templateCode start="<%" end="%>"
"hi templateCode ctermbg=darkred
hi templateCode ctermfg=Blue
syn region templateCodeInline start="<%=" end="%>"
"syn match templateCodeInline "<%=[^%]\+%>"
"hi templateCodeInline ctermbg=yellow
"hi templateCodeInline ctermfg=yellow cterm=italic
hi templateCodeInline ctermfg=Lightblue cterm=italic
